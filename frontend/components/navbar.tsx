...
function MobileAuthedMenu({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Sticky footer */}
      <div className="px-4 py-4 border-t border-border/60 bg-background/95 backdrop-blur">
        <button
          onClick={onSignOut}
...
function MobileGuestMenu({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Hero */}
      <div className="relative px-5 pt-7 pb-7 bg-gradient-to-br from-primary/15 via-accent/8 to-transparent border-b border-border/60">
